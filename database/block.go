...
func NewBlock(parentHash Hash, blockNumber, time uint64, nonce uint32, txs []Tx) Block {
	return Block{BlockHeader{Parent: parentHash, Number: blockNumber, Nonce: nonce, Time: time}, txs}
}
